...
class DisplayDriverST7735 : public DisplayDriver {
 public:
  // DisplayDriverST7735 configuration parameters.
  struct Config {
  ...
  DisplayDriverST7735(const Config& config);
 ...
 private:
  ...
  Config config_;
  const uint16_t row_start_;
  const uint16_t col_start_;
};
